...
const { data: session, status } = useSession({ required: true });
 ...
 const ticket = AllBookings?.filter(
    booking => booking.representative === session?.user.id
  ) || [];
...
const stripHtmlTags = (html: string | null | undefined) => {
  ...
  }, [ticket, searchTerm, filterByStatus, filterByReason]);
                      ...
                      <div className="bg-prim p-4 rounded-lg shadow-sm">
                        ...
                        <div className="space-y-3 text-2xl text-white">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            >
                              <option value="قيد المراجعة"> إرجاع إلى قيد المراجعة</option>
                              <option value="مرفوض">مرفوض</option>
                              <option value="منتهي">صفقة</option>
                            </select>
                          </div>
