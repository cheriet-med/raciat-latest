...
import StatisticsChart from "./chartStatistics";
import DenutStatistics from "./denutStatistics";
...
export default function Statistics() {
  ...
  const { AllBookings, error } = useFetchAllBookings();
        ...
        {isLoading ? (
          ...
          <>
            <article className="rounded-xl border border-gray-100 bg-prim p-6 w-full shadow-sm">
              <div className="flex items-center justify-between">
               <div className="space-y-4">
                  <p className="text-2xl text-white">عدد التذاكر المتوفرة</p>
                  <p className="text-3xl font-extrabold text-white">{AllBookings?.length || 0}</p>
                </div>
            ...
            <article className="rounded-xl border border-gray-100 bg-prim p-6 w-full shadow-sm">
              <div className="flex items-center justify-between">
                <div className="space-y-4">
                  ...
                  <p className="text-3xl font-extrabold text-white">{AllBookings.filter(booking => booking.status === "منتهي").length || 0}</p>
                </div>
            ...
            <article className="rounded-xl border border-gray-100 bg-prim p-6 w-full shadow-sm">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-4">
                  <p className="text-2xl text-white">إجمالي المبلغ الغير محصل " مبلغ التذاكر التي لم تتحول إلى صفقات "</p>
                  <p className="text-3xl font-extrabold text-white">SAR {
  (() => {
