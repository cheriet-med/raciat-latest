...
const NewsletterTable = () => {
  ...
  return (
    <div dir="rtl" className="w-full max-w-4xl mx-auto p-6 rounded-xl bg-gray-50">
      <div className="mb-6">
...
<tbody>
  {filteredSubscribers.length > 0 ? (
    filteredSubscribers.map((subscriber, index) => (
      <tr
        key={index}
        className="hover:bg-gray-50 transition-colors duration-150 border-b last:border-0 border-gray-50"
      >
        <td className="px-6 py-4 whitespace-nowrap text-xl font-medium text-gray-700" style={{ textAlign: 'right' }}>
          {subscriber.email}
        </td>
        <td className="px-6 py-4 whitespace-nowrap text-xl text-gray-700" style={{ textAlign: 'right' }}>
    ...
    <tr>
      <td colSpan={2} className="px-6 py-8 text-center text-gray-500 text-xl">
