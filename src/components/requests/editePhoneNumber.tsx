...
const EditPhone = ({ 
  ...
  return (
    <div className="relative">
      {/* Edit Button */}
        <button className="text-2xl font-medium text-sec hover:text-secondary flex items-center"  onClick={() => setIsOpen(true)}>
      ...
      {isOpen && (
        ...
        <div className="rounded-2xl bg-white p-6 max-w-5xl mx-auto ">
            <h2 className="text-3xl font-semibold mb-8 font-playfair">تعديل رقم الهاتف</h2>
