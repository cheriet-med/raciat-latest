...
const menuItems: MenuItem[] = [
  ...
  <div className="flex-1">
    ...
    <div className='hover:bg-accent p-1 rounded-lg' onClick={() => signOut({ callbackUrl: `/login` })}>
  ...
  <div className=' hover:bg-background p-1 rounded-lg' onClick={() => signOut({ callbackUrl: `/login` })}>
               <FiLogOut size={24} className='text-white' />
             </div>
