...
import DashboardUserTicket from "@/components/user-dashboard/ticket";
...
export default function ProtectedPage() {
  ...
  return session?.user?.is_superuser? <DashboardUserTicket/> :  ( session?.user?.is_staff? <DashboardPartner/>:<DashboardUserTicket/>)
}