...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${process.env.NEXT_PUBLIC_HOME}/reset-email`,
      languages: {
...
export default async function ResetPasswordLayout({ 
  ...
  "@type": "WebPage",
  "name":  t('update-name'),
  "url": `${process.env.NEXT_PUBLIC_HOME}/reset-email`,
  "description":  t('update-name-description'),
  "isAccessibleForFree": false,
  "security": ["HTTPS", "SameOrigin"],
  "significantLink": [
    `${process.env.NEXT_PUBLIC_HOME}/login-signin`,
    `${process.env.NEXT_PUBLIC_HOME}/account`
  ],
  "publisher": {
    "@type": "Organization",
    "name": "Padlev",
